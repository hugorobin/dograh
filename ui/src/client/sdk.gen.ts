 ...
 */
export const listPhoneNumbersApiV1PhoneNumbersGet = <ThrowOnError extends boolean = false>(options?: Options<ListPhoneNumbersApiV1PhoneNumbersGetData, ThrowOnError>) => (options?.client ?? client).get<ListPhoneNumbersApiV1PhoneNumbersGetResponses, ListPhoneNumbersApiV1PhoneNumbersGetErrors, ThrowOnError>({ url: '/api/v1/phone-numbers', ...options });
 ...
 */
export const createPhoneNumberApiV1PhoneNumbersPost = <ThrowOnError extends boolean = false>(options: Options<CreatePhoneNumberApiV1PhoneNumbersPostData, ThrowOnError>) => (options.client ?? client).post<CreatePhoneNumberApiV1PhoneNumbersPostResponses, CreatePhoneNumberApiV1PhoneNumbersPostErrors, ThrowOnError>({
 ...
 */
export const deletePhoneNumberApiV1PhoneNumbersPhoneNumberIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeletePhoneNumberApiV1PhoneNumbersPhoneNumberIdDeleteData, ThrowOnError>) => (options.client ?? client).delete<DeletePhoneNumberApiV1PhoneNumbersPhoneNumberIdDeleteResponses, DeletePhoneNumberApiV1PhoneNumbersPhoneNumberIdDeleteErrors, ThrowOnError>({ url: '/api/v1/phone-numbers/{phone_number_id}', ...options });
 ...
 */
export const updatePhoneNumberApiV1PhoneNumbersPhoneNumberIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdatePhoneNumberApiV1PhoneNumbersPhoneNumberIdPatchData, ThrowOnError>) => (options.client ?? client).patch<UpdatePhoneNumberApiV1PhoneNumbersPhoneNumberIdPatchResponses, UpdatePhoneNumberApiV1PhoneNumbersPhoneNumberIdPatchErrors, ThrowOnError>({
